...
class DLPPrinterGUI(QWidget):
    ...
    def __init_widget__(self):
        ...
        self.__left_widget.setSizePolicy(QSizePolicy.Maximum, QSizePolicy.Maximum)
        self.__right_widget = QWidget()
        self.__right_widget.setSizePolicy(QSizePolicy.Maximum, QSizePolicy.Maximum)
...
#        print(self.__left_layout.sizeHint(), self.__right_layout.sizeHint())
    ...
    def __init_printer_options_widget__(self, parent=None):
        ...
        # self.__printer_options_widget = QFrame(parent)
        self.__printer_options_widget.setSizePolicy(QSizePolicy.Maximum, QSizePolicy.Maximum)
        # self.__printer_options_widget.setFrameStyle(QFrame.Panel | QFrame.Sunken)
        # options_label = QLabel("Printer Options:", self.__printer_options_widget)
        ...
        move_edit = MyDiscreteStepsSpinBox(self.dlp_controller.get_step_length_microns() / 1000.0, self.__printer_options_widget)
        move_edit.setSuffix("mm")
        move_edit.setMaximum(1000)
        move_edit.setMinimum(-1000)
        move_edit.setDecimals(6)
        move_edit.my_value_changed_signal.connect(self.dlp_controller.update_building_plate_distance)
        ...
        options_layout.addWidget(move_edit, 1, 2)
    ...
    def __init_projector_widget__(self, parent=None):
        ...
        # self.__projector_widget = QFrame(parent)
        # self.__projector_widget.setFrameStyle(QFrame.Panel | QFrame.Sunken)
        # projector_label = QLabel("Projector Options:", self.__projector_widget)
    ...
    def __init_support_widget__(self, parent=None):
        ...
        # self.__support_widget = QFrame(parent)
        self.__support_widget.setSizePolicy(QSizePolicy.Maximum, QSizePolicy.Maximum)
        # self.__support_widget.setFrameStyle(QFrame.Panel | QFrame.Sunken)
        # support_label = QLabel("Support Layers Parameters:", self.__support_widget)
        thickness_label = QLabel("Layer Thickness", self.__support_widget)
        thickness_edit = MyDiscreteStepsSpinBox(self.dlp_controller.get_step_length_microns(), self.__support_widget)
        thickness_edit.setSuffix(str('\u03BCm'))
        thickness_edit.setMaximum(1000000)
        thickness_edit.setMinimum(0)
        thickness_edit.setDecimals(3)
        # thickness_edit.setSingleStep(self.dlp_controller.get_step_length_microns())
        thickness_edit.my_value_changed_signal.connect(self.dlp_controller.set_support_thickness)
        ...
        exposure_edit.setMaximum(100000)
        ...
        # support_layout.addWidget(support_label, 0, 0, 1, 2)
        support_layout.addWidget(thickness_label, 1, 0)
        support_layout.addWidget(thickness_edit, 1, 1)
    ...
    def __init_features_widget__(self, parent=None):
        # self.__features_widget = QFrame(parent)
        ...
        # self.__features_widget.setFrameStyle(QFrame.Panel | QFrame.Sunken)
        # support_label = QLabel("Features Layers Parameters:", self.__features_widget)
        thickness_label = QLabel("Layer Thickness", self.__features_widget)
        thickness_edit = MyDiscreteStepsSpinBox(self.dlp_controller.get_step_length_microns(), self.__features_widget)
        thickness_edit.setSuffix(str('\u03BCm'))
        thickness_edit.setMaximum(1000000)
        thickness_edit.setMinimum(0)
        thickness_edit.setDecimals(3)
        # thickness_edit.setSingleStep(self.dlp_controller.get_step_length_microns())
        thickness_edit.my_value_changed_signal.connect(self.dlp_controller.set_features_thickness)
        thickness_edit.setValue(self.dlp_controller.features_thickness * 1000)
        ...
        # features_layout.addWidget(support_label, 0, 0, 1, 2)
        features_layout.addWidget(thickness_label, 1, 0)
        features_layout.addWidget(thickness_edit, 1, 1)
    ...
    def __init_advanced_features_widget__(self, parent=None):
        # self.__advanced_widget = QFrame(parent)
        self.__advanced_widget = QGroupBox("Advanced Features Options", parent)
        self.__advanced_widget.setSizePolicy(QSizePolicy.Maximum, QSizePolicy.Maximum)
        # self.__advanced_widget.setFrameStyle(QFrame.Panel | QFrame.Sunken)
        # advanced_label = QLabel("Advanced Features Options:", self.__advanced_widget)
        ...
        starting_thickness_edit = MyDiscreteStepsSpinBox(self.dlp_controller.get_step_length_microns(), self.__features_widget)
        starting_thickness_edit.setSuffix(str('\u03BCm'))
        starting_thickness_edit.setMaximum(1000000)
        starting_thickness_edit.setMinimum(0)
        starting_thickness_edit.setDecimals(3)
        # starting_thickness_edit.setSingleStep(self.dlp_controller.get_step_length_microns())
        starting_thickness_edit.my_value_changed_signal.connect(self.dlp_controller.set_starting_incremental_thickness)
        starting_thickness_edit.setValue(self.dlp_controller.starting_incremental_thickness * 1000)
        thickness_step_label = QLabel("Step Size", self.__features_widget)
        thickness_step_edit = MyDiscreteStepsSpinBox(self.dlp_controller.get_step_length_microns(), self.__features_widget)
        thickness_step_edit.setSuffix(str('\u03BCm'))
        thickness_step_edit.setMaximum(1000000)
        thickness_step_edit.setMinimum(0)
        thickness_step_edit.setDecimals(3)
        # thickness_step_edit.setSingleStep(self.dlp_controller.get_step_length_microns())
        thickness_step_edit.my_value_changed_signal.connect(self.dlp_controller.set_incremental_step_thickness)
        thickness_step_edit.setValue(self.dlp_controller.incremental_step_thickness * 1000)
        ...
        # advanced_features_layout.addWidget(advanced_label, 0, 0, 1, 5)
        ...
        advanced_features_layout.addWidget(starting_thickness_edit, 6, 1)
        advanced_features_layout.addWidget(thickness_step_label, 6, 2)
        advanced_features_layout.addWidget(thickness_step_edit, 6, 3)
        ...
        # advanced_features_layout.addWidget(alpha_parameter_edit, 8, 1)
        # advanced_features_layout.addWidget(beta_parameter_label, 8, 2)
        # advanced_features_layout.addWidget(beta_parameter_edit, 8, 3)
        # advanced_features_layout.addWidget(gamma_parameter_label, 8, 4)
        # advanced_features_layout.addWidget(gamma_parameter_edit, 8, 5)
    ...
    def __init_start_stop_widget__(self, parent=None):
        ...
        self.__start_stop_widget.setSizePolicy(QSizePolicy.Maximum, QSizePolicy.Maximum)
        ...
        self.__start_stop_widget.setFixedSize(size.width(), size.height()/6)
    ...
    def __init_preview_widget__(self, parent=None):
        ...
        self.__preview_widget.setFixedSize(size.width(), size.height()/2.3)
